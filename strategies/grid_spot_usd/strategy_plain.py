...
def run():
    with open("./strategies/grid_spot_usd/data/last_data.json", "r", encoding="utf-8") as fopen:
        last_data = json.load(fopen)
    ...
    with open("./strategies/grid_spot_usd/data/last_data.json", "w") as outfile:
